  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Rakibul Alam | Full Stack Developer"
        />
        <meta
        ...
        <meta
          property="og:type"
          content="https://rakibul599.github.io/react-portfolio/"
        />
      ...
      <div className="min-h-screen bg-gray-50 py-10 px-6">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          ...
          <div className="bg-white shadow-md rounded-xl overflow-hidden hover:shadow-xl transition group">
            ...
            <div className="p-4 text-center">
              <h2 className="text-lg font-semibold text-gray-900">
              Mahmudul Hasan Molla
              </h2>
              <p className="text-sm text-gray-600 mt-2">Full Stack Developer</p>

              {/* Portfolio link */}
              <Link
                href="https://mahmudul-hasan-portfolio-website.vercel.app/"
                target="_blank"
                className="mt-3 inline-block text-blue-600 hover:text-blue-800 font-medium"
              >
                View Portfolio →
